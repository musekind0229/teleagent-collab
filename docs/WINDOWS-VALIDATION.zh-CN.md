...
初始日期：2026-09-07。最新实机补充：2026-09-10。当前迁移分支 `windows-integration`，上游基线 `3e4526f`，Windows 合入提交 `a9200a8`。

## 2026-09-10 实机更新

- 新增哈希固定的 `external_inputs`：只接受仓库内、非凭据类、非链接的普通文件，并固定绝对路径、SHA-256、数量和大小；批准瞬间会重新计算哈希。
